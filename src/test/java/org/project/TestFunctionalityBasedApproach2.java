...
public class TestFunctionalityBasedApproach2 {
    ...
    void testLetterCaseUpper(String input) {
        assertEquals(ROMAN_NUMERALS_LIST.indexOf(input),
                RomanConverter2.fromRoman(input));
    }
    ...
    void testSubtractiveNotationTrue() {
        assertEquals(4, RomanConverter2.fromRoman("IV"));
    }

    @Test
    void testSubtractiveNotationFalse() {
        assertEquals(4, RomanConverter2.fromRoman("IIII"));
    }
}
